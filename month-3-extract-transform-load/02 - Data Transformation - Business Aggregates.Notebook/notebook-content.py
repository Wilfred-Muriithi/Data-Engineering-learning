...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "486f4369-7736-4e5c-ad15-31479c9714a9",
# META       "default_lakehouse_name": "wwwilakehouse",
# META       "default_lakehouse_workspace_id": "0474dffc-b659-4868-9305-006659fbd378"
# META     }
# META   }
# META }
...
df_fact_sale = spark.read.table("wwwilakehouse.fact_sale") 
df_dimension_date = spark.read.table("wwwilakehouse.dimension_date")
df_dimension_city = spark.read.table("wwwilakehouse.dimension_city")
...
# MAGIC FROM wwwilakehouse.fact_sale FS
# MAGIC INNER JOIN wwwilakehouse.dimension_date DD ON FS.InvoiceDateKey = DD.Date
# MAGIC INNER JOIN wwwilakehouse.dimension_Employee DE ON FS.SalespersonKey = DE.EmployeeKey
